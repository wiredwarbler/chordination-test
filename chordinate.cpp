...
/* ACTOR */
Actor::Actor(int i, int lvl, std::string n, int h, int a, int d, int s, int l) :
    hp(StatType::HitPoints, h), // otherwise these will be initialized before the constructor code runs
...
/* HERO */
Hero::Hero(int i, int lvl, int ps, std::string n, Voice v, int h, int a, int d, int s, int l) : 
    Actor(i, lvl, n, h, a, d, s, l) 
{
    voice = v;
    partySequence = ps;
};
